...
namespace Entitas {
    ...
    public class Context<TEntity> : IContext<TEntity> where TEntity : class, IEntity {
        ...
        readonly EntityMessageSend _cachedEntityMessageSend;
        ...
        public Context(int totalComponents, int startCreationIndex, ContextInfo contextInfo, Func<IEntity, IAERC> aercFactory, Func<TEntity> entityFactory) {
            ...
            _cachedEntityMessageSend = sendMessage;
        }
        ...
        public TEntity CreateEntity() {
            ...
            entity.OnMessageSend += _cachedEntityMessageSend;
        ...
        void sendMessage(IEntity entity, int index, IMessage message)
        {
            if (OnMessageSend != null) {
                OnMessageSend(entity, index, message);
            }
        }
