...
${MessageTypesList}
    ...
    public static readonly SyncType[] MessageSyncTypes = {
${MessageSyncTypeList}
    };
}
";
        ...
        const string MESSAGE_SYNC_TYPE_TEMPLATE = @"        ${MessageSyncType}";
        ...
        CodeGenFile generateMessagesLookupClass(string contextName, MessageData[] data) {
            ...
            var MessageSyncTypeList = string.Join(",\n", data
                .Select(d => MESSAGE_SYNC_TYPE_TEMPLATE
                    .Replace("${MessageSyncType}", d.GetSyncTypeName())
                ).ToArray());
            ...
            var fileContent = TEMPLATE
                ...
                .Replace("${MessageSyncTypeList}", MessageSyncTypeList);
